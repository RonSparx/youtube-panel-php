...
--
-- Host: localhost:3306
-- Generation Time: Aug 18, 2023 at 10:38 PM
...
(1, '3', 'Admin', 'admin@admin.com', 'admin', 'fb6c98c7ce09240685b76bc922bfcc8d', '', '2021-09-08 10:19:05', '2023-08-18 00:58:18', '152.58.75.200', '2', '{\"admin_access\":1,\"users\":1,\"services\":1,\"update-prices\":1,\"bulk\":1,\"synced-logs\":1,\"orders\":1,\"subscriptions\":1,\"dripfeed\":1,\"tasks\":1,\"payments\":1,\"tickets\":1,\"additionals\":1,\"referral\":1,\"broadcast\":1,\"logs\":1,\"reports\":1,\"videop\":1,\"coupon\":1,\"child-panels\":1,\"updates\":1,\"appearance\":1,\"themes\":1,\"new_year\":1,\"pages\":1,\"news\":1,\"meta\":1,\"blog\":1,\"menu\":1,\"inte\":1,\"language\":1,\"files\":1,\"settings\":1,\"general_settings\":1,\"providers\":1,\"payments_settings\":1,\"bank_accounts\":1,\"modules\":1,\"subject\":1,\"payments_bonus\":1,\"currency-manager\":1,\"alert_settings\":1,\"site_count\":1,\"manager\":1,\"super_admin\":1}', 'sun', '0', '');
...
CREATE TABLE `categories` (
  ...
  `category_name_lang` json DEFAULT NULL,
...
CREATE TABLE `menus` (
  ...
  `menu_name_lang` json DEFAULT NULL,
...
CREATE TABLE `news` (
  ...
  `news_title_lang` json DEFAULT NULL,
  `news_content` varchar(225) NOT NULL,
  `news_content_lang` json DEFAULT NULL,
...
CREATE TABLE `service_api` (
  ...
  `currency` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
